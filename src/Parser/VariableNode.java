...
public class VariableNode extends Node {
     ...
     */
    public VariableNode(String n, String ty, boolean ch) {
        this.variableName = n;
        this.changeable = ch;
        typeFetcher(ty);
    }
     ...
     */
    public VariableNode(String n, String ty, boolean ch, boolean var) {
        this.variableName = n;
        typeFetcher(ty);
        this.changeable = ch;
        isVar = var;
     ...
     */
    public VariableNode(String n, String ty, int f, int t, boolean ch, boolean isArr) {
        this.variableName = n;
        typeFetcher(ty);
        this.from = f;
        this.to = t;
    ...
    public VariableNode(String n, String ty, int f, int t, boolean ch, boolean isArr, boolean isVar) {
        this.variableName = n;
        typeFetcher(ty);
        this.from = f;
        this.to = t;
     ...
     */
    public VariableNode(String n, String ty, float f, float t, boolean ch) {
        this.variableName = n;
        typeFetcher(ty);
        this.realFrom = f;
        this.realTo = t;
    ...
    private void typeFetcher(String ty) {
        switch (ty) {
            case "INTEGER":
            ...
            case "BOOLEAN":
                ...
                break;
            default:
                throw new SyntaxErrorException("attempting to create a variable of invalid type (TYPE: " + ty + " at variable " + variableName + ")");
        }
    }
